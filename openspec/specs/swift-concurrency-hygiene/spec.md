# swift-concurrency-hygiene Specification

## Purpose
Define the project's requirements for actor-isolation-safe Swift code and bounded JSON codec ownership without changing serialization behavior.
