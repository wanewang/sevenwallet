# wallet-token-market-metadata Specification

## Purpose
Define how wallet token market metadata, matching keys, and normalized cache records are represented, decoded, stored, composed, and purged.
