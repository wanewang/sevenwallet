# Wallet Home Market Enrichment

## Purpose

Define how the selected-wallet home sequences token-market loading, enriches matching holdings, retries transient failures, presents market state, and keeps enrichment in memory.
